...
**встроит локальный Manrope** (лежит в `pdf2docx_converter/assets/`, лицензия OFL)
и уберёт Google-ссылки. Рендер становится офлайновым и детерминированным, дизайн
не «уезжает» в системный шрифт. (Для других шрифтов — встрой их в HTML или
установи в систему.)

**Зачем нужен фикс вариативных шрифтов.** Chrome печатает **вариативные** шрифты в PDF как **Type3**
